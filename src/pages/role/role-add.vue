<template>
  <div
    class="add-role"
    v-if="dataPermissionUser && dataPermissionUser.includes('CNPS_CFG_ROLE_SAVE')"
  >
    ...
    <div class="card p-10 pt-15 b-t-1-869fb229">
      <div class="card-body px-20">
        <form class="col-md-6 px-0">
          <h1 class="f16 py-3">Thông tin thêm mới</h1>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                      ...
                      <h2 class="f18 py-3">Thêm mới quyền thành công</h2>
                    </div>
                    <div class="modal-footer">
                      <a
                        href="/role"
...
export default {
  ...
  methods: {
    ...
    async submitInsert () {
      ...
      this.validate = true
      this.dataInsert.name = this.dataInsert.name.trim()
      this.dataInsert.userId = this.dataUser.userId
      this.dataInsert.description = this.dataInsert.description.trim()
      this.dataInsert.permissionCodes = this.listCheckBox
      const data = await RoleService.addRole(this.dataInsert)
      if (data.success) {
