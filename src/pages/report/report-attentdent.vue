      ...
      <div class="card-header m-b-10">
        <form class="box-search">
          ...
          <div class="form-group">
            ...
            <Select2 v-model="search.province" :options="dataProvince" />
          </div>
          <div class="form-group">
      ...
      try {
        ...
        if (this.search.region) {
          const data = this.dataConfigRegion.filter((e) => {
            return this.search.region === e.id
          })
        ...
        this.search.endDate = moment(this.dateRange.endDate)
          ...
          .add(7, 'hours')
          .valueOf()
        this.search.fromDate = moment(this.dateRange.startDate)
          .startOf('day')
          .add(7, 'hours')
          .valueOf()
        this.search.typeExport = 'GENERAL'
        const res = await StaffService.export(this.search)
        if (res.success) {
